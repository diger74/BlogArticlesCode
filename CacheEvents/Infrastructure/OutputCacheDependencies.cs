...
namespace DancingGoat.Infrastructure
{
    ...
    public sealed class OutputCacheDependencies : IOutputCacheDependencies
    {
        ...
        /// <summary>
        /// Adds a minimum set of ASP.NET output cache dependencies for a view that contains cached data dependent on dummy cache key.
        /// When specified dummy key is touched, the corresponding output cache item is invalidated.
        /// </summary>
        /// <param name="dummyKey">Dummy cache key</param>
        public void AddDependencyOnDummyKey(string dummyKey)
        {
            if (!mCacheEnabled || string.IsNullOrWhiteSpace(dummyKey))
            {
                return;
            }
